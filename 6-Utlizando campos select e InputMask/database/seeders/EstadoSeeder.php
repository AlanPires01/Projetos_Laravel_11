...
class EstadoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $estados = [
            ...
            ['id' => 3, 'nome_estado' => 'Amazonas', 'sigla' => 'AM'],
            ['id' => 4, 'nome_estado' => 'Amapá', 'sigla' => 'AP'],
            ...
            ['id' => 11, 'nome_estado' => 'Minas Gerais', 'sigla' => 'MG'],
            ['id' => 12, 'nome_estado' => 'Mato Grosso do Sul', 'sigla' => 'MS'],
            ['id' => 13, 'nome_estado' => 'Mato Grosso', 'sigla' => 'MT'],
            ['id' => 14, 'nome_estado' => 'Pará', 'sigla' => 'PA'],
            ['id' => 15, 'nome_estado' => 'Paraíba', 'sigla' => 'PB'],
            ['id' => 16, 'nome_estado' => 'Pernambuco', 'sigla' => 'PE'],
            ['id' => 17, 'nome_estado' => 'Piauí', 'sigla' => 'PI'],
            ['id' => 18, 'nome_estado' => 'Paraná', 'sigla' => 'PR'],
            ['id' => 19, 'nome_estado' => 'Rio de Janeiro', 'sigla' => 'RJ'],
            ['id' => 20, 'nome_estado' => 'Rio Grande do Norte', 'sigla' => 'RN'],
            ['id' => 21, 'nome_estado' => 'Rondônia', 'sigla' => 'RO'],
            ['id' => 22, 'nome_estado' => 'Roraima', 'sigla' => 'RR'],
            ['id' => 23, 'nome_estado' => 'Rio Grande do Sul', 'sigla' => 'RS'],
            ['id' => 24, 'nome_estado' => 'Santa Catarina', 'sigla' => 'SC'],
            ['id' => 25, 'nome_estado' => 'Sergipe', 'sigla' => 'SE'],
            ['id' => 26, 'nome_estado' => 'São Paulo', 'sigla' => 'SP'],
